...
Instituição: Universidade Anhanguera-Uniderp (UNIDERP)
...
### 🔹 Programação em C
Desenvolvimento de programas para prática de lógica de programação, funções, estruturas de repetição e manipulação de dados.

### 🔹 Montagem e Configuração de Computadores
Instalação de hardware, sistemas operacionais, drivers e softwares essenciais.

### 🔹 Projetos Acadêmicos
Participação em atividades práticas e resolução de problemas computacionais durante a graduação.

---

## 📈 Estatísticas GitHub

![GitHub Stats](https://github-readme-stats.vercel.app/api?username=Hydra-0n&show_icons=true&theme=tokyonight)

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Hydra-on&layout=compact&theme=tokyonight)
